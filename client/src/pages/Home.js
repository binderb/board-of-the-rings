...
export default function Home() {
  return (
    <div className="flex flex-col p-4 items-center">
      <h1 className="title mb-0">Board of the Rings</h1>
      <p className="description text-center text-[30px]">
        An Unexpected Party Game
      </p>
      ...
      <div className="flex flex-wrap justify-center w-full max-w-[600px] ">
